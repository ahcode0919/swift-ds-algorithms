...
struct MergeListsTests {
    ...
    @Test func testMergeLists() throws {
        var list1: SinglyLinkedListNode<Int>? = SinglyLinkedListData.linkedList(from: [1, 4, 5, 7, 10])
        var list2: SinglyLinkedListNode<Int>? = SinglyLinkedListData.linkedList(from: [0, 3, 6, 8, 10, 11])
        ...
        list1 = SinglyLinkedListData.linkedList(from: [1, 2, 3])
        list2 = nil
        result = MergeLists.merge(head1: list1, head2: list2)
