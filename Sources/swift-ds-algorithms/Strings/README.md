...
```swift
static func containsWithRange(_ string1: String, contains string2: String) -> Bool {
    if string1.count < string2.count || string1.isEmpty && string2.isEmpty { return false }
...
```swift
static func containsWithLoop(_ string1: String, contains string2: String) -> Bool {
    if string1.count < string2.count || string1.isEmpty && string2.isEmpty { return false }
...
```swift
static func containsWithStringAPI(_ string1: String, contains string2: String) -> Bool {
...
```swift
static func findLongestPrefix(_ string1: String) -> String {
    let words = string1.components(separatedBy: " ")

    guard words.count > 1 else { return string1 }
...
```swift
static func isPangramWithSet(_ string1: String) -> Bool {
...
static func isPangramWithLoop(_ string1: String) -> Bool {
...
```swift
static func hasSameCharactersWithLoop(_ string1: String, in string2: String) -> Bool {
...
```swift
static func hasSameCharactersWithSort(_ string1: String, in string2: String) -> Bool {
    if string1.count != string2.count { return false }
...
```swift
static func hasSameCharactersWithDictionary(_ string1: String, in string2: String) -> Bool {
    if string1.count != string2.count { return false }
...
```swift
static func threeDifferentLetters(string1: String, string2: String) -> Bool {
...
static func vowelsAndConsonantsForEach(_ string1: String) -> (vowels: Int, consonants: Int) {
    let normalizedString = string1.lowercased()
